...
async def analyze_mlb_day(
    ...
    *,
    ...
    for res in enrichment_results:
        ...
        # F99: lógica extraída a ``mlb_day_context_builder.apply_statcast_phase9_adjustments``.
        # Mutación in-place sobre ``pick_payload``; mismo I/O y mismas
        # reason codes que la versión inline pre-F99. Conservamos el
        # comentario doctrinal aquí para que el lector del orchestrator
        # sepa qué hace este step sin tener que abrir el helper.
        try:
            from .mlb_day_context_builder import apply_statcast_phase9_adjustments
            apply_statcast_phase9_adjustments(pick_payload, chosen_market)
        ...
        # F100: lógica extraída a ``mlb_day_context_builder.apply_offensive_pressure_base``.
        try:
            from .mlb_day_context_builder import apply_offensive_pressure_base
            apply_offensive_pressure_base(pick_payload, chosen_market)
        ...
        # F100: lógica extraída a ``mlb_day_context_builder.apply_sabermetrics_layer``.
        try:
            from .mlb_day_context_builder import apply_sabermetrics_layer
            apply_sabermetrics_layer(pick_payload, chosen_market)
        ...
        # F100: lógica extraída a ``mlb_day_context_builder.apply_market_selection_intelligence``.
        try:
            from .mlb_day_context_builder import apply_market_selection_intelligence
            apply_market_selection_intelligence(pick_payload)
        ...
        # F100: lógica extraída a ``mlb_day_context_builder.apply_intelligence_warehouse``.
        try:
            from .mlb_day_context_builder import apply_intelligence_warehouse
            await apply_intelligence_warehouse(pick_payload, db)
        ...
        # F100: lógica extraída a ``mlb_day_context_builder.seal_pipeline_payload_contract``.
        try:
            from .mlb_day_context_builder import seal_pipeline_payload_contract
            seal_pipeline_payload_contract(pick_payload)
