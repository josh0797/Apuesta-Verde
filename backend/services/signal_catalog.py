...
SIGNAL_CATALOG: dict[str, dict[str, Any]] = {
    ...
    # ── MLB-V5 Structural Lean & Manual Review signals ─────────────────
    "ODDS_MISSING_STRUCTURAL_ANALYSIS_ONLY": {
        "label":       "Sin cuota — análisis estructural disponible",
        "label_en":    "Odds missing — structural analysis only",
        "severity":    "medium",
        "category":    "structural",
        "signal_type": "neutral",
        "explanation": "No hay cuota automática para este juego, pero el motor MLB cuenta con datos suficientes (pitchers, bullpen, ofensiva, parque) para una lectura estructural.",
        "default_impact": "Marcado para revisión manual de cuota — no descartado.",
        "applicable_sports": BASEBALL_ONLY,
    },
    "STRUCTURAL_LEAN_DETECTED": {
        "label":       "Lectura estructural detectada",
        "label_en":    "Structural lean detected",
        "severity":    "medium",
        "category":    "tactical",
        "signal_type": "positive",
        "explanation": "El engine MLB v2 identificó una inclinación clara (Run Line, total protegido, NRFI/YRFI o team total).",
        "default_impact": "Revisar manualmente la cuota antes de invertir.",
        "applicable_sports": BASEBALL_ONLY,
    },
    "MANUAL_ODDS_REQUIRED": {
        "label":       "Pega tu cuota para calcular edge",
        "label_en":    "Manual odds required",
        "severity":    "low",
        "category":    "structural",
        "signal_type": "neutral",
        "explanation": "Para que el engine calcule edge, pega la cuota de tu bookie en el panel de revisión manual.",
        "default_impact": "Permite recálculo cliente-side del edge cuando llega la cuota.",
        "applicable_sports": BASEBALL_ONLY,
    },
    "MOTIVATION_NEUTRAL_MLB": {
        "label":       "Motivación normal — irrelevante para MLB",
        "label_en":    "Motivation neutral — MLB",
        "severity":    "low",
        "category":    "narrative",
        "signal_type": "neutral",
        "explanation": "Motivación normal en MLB no bloquea análisis; pesan más pitchers, lineups, bullpen y matchup.",
        "default_impact": "No reduce score; sólo añade transparencia narrativa.",
        "applicable_sports": BASEBALL_ONLY,
    },
    "DISCARDED_ONLY_AFTER_FULL_ANALYSIS": {
        "label":       "Descartado tras análisis completo",
        "label_en":    "Discarded after full analysis",
        "severity":    "low",
        "category":    "structural",
        "signal_type": "neutral",
        "explanation": "El engine MLB completó el análisis estructural y no detectó lectura aprovechable, ni siquiera para revisión manual.",
        "default_impact": "Descartado por falta de edge real, no por ausencia de cuota.",
        "applicable_sports": BASEBALL_ONLY,
    },
    "PARK_OVER_SIGNAL": {
