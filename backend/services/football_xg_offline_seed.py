...
# Aliases + normalización extraídos a services/team_aliases.py — single
# source of truth compartida con football_corners_offline_seed.py.
from .team_aliases import (
    TEAM_ALIASES as _TEAM_ALIASES,    # back-compat alias para tests/consumers internos
