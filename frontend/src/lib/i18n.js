...
const STRINGS = {
  es: {
    ...
    history: { title: 'Historial de picks', subtitle: 'Tracking personal de aciertos', winRate: 'Winrate', settled: 'Decididos', streak: 'Racha', last10: 'Últimos 10', byTier: 'Por nivel de confianza', empty: 'Aún no has marcado picks. Marca "Gané / Perdí / Push" desde el detalle del partido.', evolution: 'Evolución del winrate', exportCsv: 'Exportar CSV', roiTitle: 'Calculadora ROI', stakeLabel: 'Stake por pick', roiTotalWagered: 'Apostado', roiNetProfit: 'Ganancia neta', roiPct: 'ROI', roiAvgWonOdds: 'Cuota media ganada', roiAvgLostOdds: 'Cuota media perdida', settledWithOdds: 'con cuota', roiHint: 'ROI calculado solo sobre picks con cuota registrada. Algunos picks antiguos pueden no tenerla.' },
