...
const STRINGS = {
  ...
  en: {
    ...
    history: { title: 'Pick history', subtitle: 'Personal accuracy tracking', winRate: 'Win rate', settled: 'Settled', streak: 'Streak', last10: 'Last 10', byTier: 'By confidence tier', empty: 'No tracked picks yet. Mark "Won / Lost / Push" from match detail.', evolution: 'Win rate evolution', exportCsv: 'Export CSV' },
