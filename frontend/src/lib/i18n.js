...
const STRINGS = {
  es: {
    ...
    dashboard: { title: 'Picks del día', subtitle: 'Análisis de valor para las próximas 48 horas', generateBtn: 'Generar picks del día', refreshingData: 'Actualizando datos…', running: 'Analizando partidos…', lastRun: 'Última ejecución', noRunYet: 'Aún no has generado picks. Pulsa el botón para correr el análisis.', groupHigh: 'Alta confianza', groupMedium: 'Confianza media', groupDiscMotivation: 'Descartados por motivación', groupDiscMarket: 'Descartados por mercado frágil', groupIncomplete: 'Datos incompletos', summary: 'Resumen', analyzed: 'Analizados', recommended: 'Recomendados', discarded: 'Descartados', noValueTitle: 'Hoy no hay valor', noValueMsg: 'No apostar es la mejor apuesta. Mejor preservar el bankroll que forzar picks débiles.' },
    live: { title: 'Partidos en vivo', subtitle: 'Reevaluación en tiempo real con live stats', noLive: 'No hay partidos en vivo en este momento.', minute: "min", possession: 'Posesión', shots: 'Tiros', shotsOn: 'A puerta', corners: 'Córners', xg: 'xG' },
    ...
    history: { title: 'Historial de picks', subtitle: 'Tracking personal de aciertos', winRate: 'Winrate', settled: 'Decididos', streak: 'Racha', last10: 'Últimos 10', byTier: 'Por nivel de confianza', empty: 'Aún no has marcado picks. Marca “Gané / Perdí / Push” desde el detalle del partido.' },
    profile: { title: 'Perfil', signOut: 'Cerrar sesión', language: 'Idioma', emailLabel: 'Email', joinedOn: 'Miembro desde', stats: 'Estadísticas globales', upcomingPlaceholder: 'ROI y filtros avanzados próximamente.' },
    freshness: { fresh: 'datos frescos', stale: 'datos antiguos', missing: 'sin datos' },
    confidence: { Maxima: 'Máxima', Alta: 'Alta', Media: 'Media' },
    common: { loading: 'Cargando…', error: 'Error', retry: 'Reintentar', save: 'Guardar', cancel: 'Cancelar', open: 'Abrir', close: 'Cerrar' }
  },
  en: {
    appName: 'Value Bet Intelligence',
    ...
    dashboard: { title: "Today's picks", subtitle: 'Value analysis for the next 48 hours', generateBtn: "Generate today's picks", refreshingData: 'Refreshing data…', running: 'Analyzing matches…', lastRun: 'Last run', noRunYet: 'No picks generated yet. Hit the button to run the analyst.', groupHigh: 'High confidence', groupMedium: 'Medium confidence', groupDiscMotivation: 'Discarded — motivation', groupDiscMarket: 'Discarded — fragile market', groupIncomplete: 'Incomplete data', summary: 'Summary', analyzed: 'Analyzed', recommended: 'Recommended', discarded: 'Discarded', noValueTitle: 'No value today', noValueMsg: "Not betting is the best bet. Better preserve bankroll than force weak picks." },
    live: { title: 'Live matches', subtitle: 'Real-time re-evaluation with live stats', noLive: 'No live matches right now.', minute: "'", possession: 'Possession', shots: 'Shots', shotsOn: 'On target', corners: 'Corners', xg: 'xG' },
    ...
    history: { title: 'Pick history', subtitle: 'Personal accuracy tracking', winRate: 'Win rate', settled: 'Settled', streak: 'Streak', last10: 'Last 10', byTier: 'By confidence tier', empty: 'No tracked picks yet. Mark “Won / Lost / Push” from the match detail.' },
    profile: { title: 'Profile', signOut: 'Sign out', language: 'Language', emailLabel: 'Email', joinedOn: 'Member since', stats: 'Overall stats', upcomingPlaceholder: 'ROI and advanced filters coming soon.' },
    freshness: { fresh: 'fresh data', stale: 'stale data', missing: 'missing data' },
    confidence: { Maxima: 'Max', Alta: 'High', Media: 'Medium' },
    common: { loading: 'Loading…', error: 'Error', retry: 'Retry', save: 'Save', cancel: 'Cancel', open: 'Open', close: 'Close' }
  }
};
